...
import Content1 from './tabComponents/Content1';
import Content2 from './tabComponents/Content2';

export default function MenuTabs() {
  return (
    <Tabs forceRenderTabPanel defaultIndex={2}>
      <TabList>
      ...
      <TabPanel>
        <Tabs forceRenderTabPanel>
          ...
          <TabPanel>
            <p>
              Protagonist, from the 20th Century. Delivery boy. Many times great-uncle to Professor Hubert Farnsworth.
              Suitor of Leela.
            </p>
            <img
          ...
          <TabPanel>
            <p>
              ...
              Mexico, he is the Planet Express Ships cook.
            </p>
            <img
          ...
          <TabPanel>
            <p>
              Many times great-nephew of Fry. CEO and owner of Planet Express delivery company. Tenured professor of
              Mars University.
            </p>
            <img
          ...
          <TabPanel>
            <p>
              Alien from Decapod 10. Planet Express staff doctor and steward. Has a medical degree and Ph.D in art
              history.
            </p>
            <img
